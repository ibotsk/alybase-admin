...
class ListOfSpecies extends AppModel {
    ...
    /**
     * If any hybrid field si not empty, set the name as hybrid
     * @param type $options
     * @return boolean
     */
    public function beforeSave($options = array()) {
        //return parent::beforeSave($options);
        if (!empty($this->data['ListOfSpecies']['genus_h']) 
                || !empty($this->data['ListOfSpecies']['species_h']) 
                || !empty($this->data['ListOfSpecies']['subsp_h'])
                || !empty($this->data['ListOfSpecies']['var_h'])
                || !empty($this->data['ListOfSpecies']['subvar_h'])
                || !empty($this->data['ListOfSpecies']['forma_h'])
                || !empty($this->data['ListOfSpecies']['authors_h'])) {
            $this->data['ListOfSpecies']['hybrid'] = true;
        } else {
            $this->data['ListOfSpecies']['hybrid'] = false;
        }
        return true;
    }
